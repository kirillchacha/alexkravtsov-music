...
//#endregion
//#region src/components/custom/otherhero/otherhero.js
document.addEventListener("DOMContentLoaded", () => {
	playButtonHtml();
});
function playButtonHtml() {
	const playButton = document.querySelector(".hero-page__preview");
	const videoIframe = document.querySelector(".hero-page__iframe");
